...
# Function to scrape all courses with pagination handling
        ...
        try:
            ...
            for card in course_cards:
                ...
                if link and 'href' in link.attrs:
                    ...
                    time.sleep(0.5)  # Adjust delay to be polite to the server
...
# Write to JSON
if all_courses:
    with open('1_courses.json', 'w', encoding='utf-8') as file:
...
# Print the first course as a sample (if any courses were scraped)
if all_courses:
